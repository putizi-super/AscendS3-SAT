...
def soft_max(x_in__, y_out_, dim=-1, kernel_name="soft_max", impl_mode=""):
    ...
    origin_func_name = "soft_max"
    ascendc_src_dir_ex = "soft_max"
    ascendc_src_dir = "soft_max"
    ascendc_src_file = "soft_max.cpp"
