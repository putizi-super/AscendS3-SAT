...
uint32_t socSupportList[] = {SOC_VERSION_ASCEND310B,SOC_VERSION_ASCEND310P};
...
TensorDesc inputDesc1_1[2] =
    {{ge::DT_FLOAT, ge::FORMAT_ND},
     {ge::DT_FLOAT, ge::FORMAT_ND}};
TensorDesc inputDesc1_2[2] =
    {{ge::DT_INT8, ge::FORMAT_ND},
     {ge::DT_INT8, ge::FORMAT_ND}};
TensorDesc inputDesc1_3[2] =
    {{ge::DT_INT32, ge::FORMAT_ND},
     {ge::DT_INT32, ge::FORMAT_ND}};
...
SupportInfo list1_2 = {inputDesc1_2, 2, outputDesc1_2, 1};
SupportInfo list1_3 = {inputDesc1_3, 2, outputDesc1_3, 1};
