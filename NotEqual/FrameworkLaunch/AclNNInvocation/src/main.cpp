...
OperatorDesc CreateOpDesc()
{
    ...
    // test-2.1
    // aclDataType dataType = ACL_FLOAT16;
    // std::vector<int64_t> shape {2,3,4,5,6,7};   
    ...
    // test-8
    // std::vector<int64_t> shape {9,100,5,1024};
    // aclDataType dataType = ACL_INT8;

    // test-9.1
    // std::vector<int64_t> shape {2,1,55000};
    // aclDataType dataType = ACL_INT8;

    // test-9.2
    // std::vector<int64_t> shape {13,17,19};
    // aclDataType dataType = ACL_INT8;

    // test-11
    // aclDataType dataType = ACL_FLOAT16;
    // std::vector<int64_t> shape {1, 64, 32};
    // std::vector<int64_t> shape1 {64, 1, 32};
    // std::vector<int64_t> shape2 {64, 64, 32};

    // test-12
    aclDataType dataType = ACL_FLOAT16;
    std::vector<int64_t> shape {2, 1, 3};
    std::vector<int64_t> shape1 {2, 2, 3};
    ...
    opDesc.AddOutputTensorDesc(dataType_y, shape1.size(), shape1.data(), format);
    return opDesc;
}
