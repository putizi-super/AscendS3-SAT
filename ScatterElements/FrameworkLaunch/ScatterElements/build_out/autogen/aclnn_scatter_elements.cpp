    ...
    aclOpExecutor **executor)
{
    ...
    NNOPBASE_ASSERT_NOTNULL_RETVAL(var);
    ...
    *executor = reinterpret_cast<aclOpExecutor *>(nnopExecutor);
    ...
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddInput(*executor, var, 0));
    ...
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddAttrWithDtype(*executor, static_cast<void*>(&axisOptional), sizeof(int64_t), 0, kNnopbaseInt));
    if (reduceOptional) {
        ...
        static char *reduceOptionalDef = "assign";
    ...
    if (NnopbaseAddParamName != NULL) {
        NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddParamName(*executor, 0, "var", true));
