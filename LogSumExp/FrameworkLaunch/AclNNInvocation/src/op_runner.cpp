...
bool OpRunner::RunOp()
{
	...
	auto ret = aclnnSoftMaxGetWorkspaceSize(inputTensor_[0], opDesc_->dim, outputTensor_[0],
	...
	INFO_LOG("Execute aclnnSoftMaxGetWorkspaceSize success, workspace size %lu", workspaceSize);
	...
	INFO_LOG("Execute aclnnSoftMax success");
